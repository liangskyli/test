(self["webpackChunkreact_h5_example"] = self["webpackChunkreact_h5_example"] || []).push([["mf-dep__mfsu-dev_mf-va_mockjs_js"],{

/***/ "./.mfsu-dev/mf-va_mockjs.js":
/*!***********************************!*\
  !*** ./.mfsu-dev/mf-va_mockjs.js ***!
  \***********************************/
...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in mockjs__WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== "default") __WEBPACK_REEXPORT_OBJECT__[__WEBPACK_IMPORT_KEY__] = function(key) { return mockjs__WEBPACK_IMPORTED_MODULE_0__[key]; }.bind(0, __WEBPACK_IMPORT_KEY__)
...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return (
    ...
    function (modules) {
      ...
      function __nested_webpack_require_579__(moduleId) {
        /******/
        ...
        modules[moduleId].call(module.exports, module, module.exports, __nested_webpack_require_579__);
        /******/
      ...
      __nested_webpack_require_579__.m = modules;
      /******/
      // expose the module cache

      /******/

      __nested_webpack_require_579__.c = installedModules;
      /******/
      // __webpack_public_path__

      /******/

      __nested_webpack_require_579__.p = "";
      /******/
      // Load entry module and return exports

      /******/

      return __nested_webpack_require_579__(0);
      /******/
    }(
    /************************************************************************/
    ...
    /***/
    function (module, exports, __nested_webpack_require_2152__) {
      /* global require, module, window */
      var Handler = __nested_webpack_require_2152__(1);

      var Util = __nested_webpack_require_2152__(3);

      var Random = __nested_webpack_require_2152__(5);

      var RE = __nested_webpack_require_2152__(20);

      var toJSONSchema = __nested_webpack_require_2152__(23);

      var valid = __nested_webpack_require_2152__(25);

      var XHR;
      if (typeof window !== 'undefined') XHR = __nested_webpack_require_2152__(27);
      /*!
          Mock - 模拟请求 & 模拟数据
    ...
    /***/
    function (module, exports, __nested_webpack_require_4060__) {
      /* 
          ## Handler
      	    处理数据模板。
      	...
      	*/
      var Constant = __nested_webpack_require_4060__(2);

      var Util = __nested_webpack_require_4060__(3);

      var Parser = __nested_webpack_require_4060__(4);

      var Random = __nested_webpack_require_4060__(5);

      var RE = __nested_webpack_require_4060__(20);
      ...
      */
      ...
      Handler.extend({
        ...
        placeholder: function placeholder(_placeholder, obj, templateContext, options) {
          ...
          if (!(key in Random) && !(lkey in Random) && !(okey in Random)) return _placeholder; // 递归解析参数中的占位符
    ...
    /***/
    function (module, exports, __nested_webpack_require_28239__) {
      /*
      	## Parser
      		解析数据模板（属性名部分）。
      		* Parser.parse( name )
      		...
      		```
       */
      var Constant = __nested_webpack_require_28239__(2);

      var Random = __nested_webpack_require_28239__(5);
      /* jshint -W041 */
    ...
    /***/
    function (module, exports, __nested_webpack_require_30482__) {
      /*
          ## Mock.Random
          
          工具类，用于生成各种随机数据。
      */
      var Util = __nested_webpack_require_30482__(3);

      var Random = {
        extend: Util.extend
      };
      Random.extend(__nested_webpack_require_30482__(6));
      Random.extend(__nested_webpack_require_30482__(7));
      Random.extend(__nested_webpack_require_30482__(8));
      Random.extend(__nested_webpack_require_30482__(10));
      Random.extend(__nested_webpack_require_30482__(13));
      Random.extend(__nested_webpack_require_30482__(15));
      Random.extend(__nested_webpack_require_30482__(16));
      Random.extend(__nested_webpack_require_30482__(17));
      Random.extend(__nested_webpack_require_30482__(14));
      Random.extend(__nested_webpack_require_30482__(19));
    ...
    /***/
    function (module, exports, __nested_webpack_require_39932__) {
      ...
      (function (module) {
        ...
        */
        ...
        /* WEBPACK VAR INJECTION */
      }).call(exports, __nested_webpack_require_39932__(9)(module));
      /***/
    },
    /* 9 */
    ...
    /***/
    function (module, exports, __nested_webpack_require_50526__) {
      /*
          ## Color
      ...
      */
      var Convert = __nested_webpack_require_50526__(11);

      var DICT = __nested_webpack_require_50526__(12);
    ...
    /***/
    function (module, exports, __nested_webpack_require_61896__) {
      /*
          ## Text
      	    http://www.lipsum.com/
      */
      var Basic = __nested_webpack_require_61896__(6);

      var Helper = __nested_webpack_require_61896__(14);
    ...
    /***/
    function (module, exports, __nested_webpack_require_66198__) {
      /*
          ## Helpers
      */
      var Util = __nested_webpack_require_66198__(3);
      ...
      module.exports = {
        ...
        pick: function pick(arr, min, max) {
          ...
          if (min === 1 && max === 1) return arr[this.natural(0, arr.length - 1)]; // pick( [ item1, item2 ... ], min, max )

          return this.shuffle(arr, min, max); // 通过参数个数判断方法签名，扩展性太差！#90
          // switch (arguments.length) {
          // 	case 1:
          // 		// pick( [ item1, item2 ... ] )
        ...
        */
        order: function order(array) {
          ...
          if (arguments.length > 1) array = [].slice.call(arguments, 0); // options.context.path/templatePath
      ...
      */
      module.exports = {
        ...
        first: function first() {
          ...
          return this.pick(names); // or this.capitalize(this.word())
        },
        // 随机生成一个常见的英文姓。
        last: function last() {
      ...
      module.exports = {
        ...
        */
        ...
        email: function email(domain) {
          return this.character('lower') + '.' + this.word() + '@' + (domain || this.word() + '.' + this.tld()); // return this.character('lower') + '.' + this.last().toLowerCase() + '@' + this.last().toLowerCase() + '.' + this.tld()
    ...
    /***/
    function (module, exports, __nested_webpack_require_75881__) {
      /*
          ## Address
      */
      var DICT = __nested_webpack_require_75881__(18);
    ...
    /***/
    function (module, exports, __nested_webpack_require_180389__) {
      /*
          ## Miscellaneous
      */
      var DICT = __nested_webpack_require_180389__(18);
    ...
    /***/
    function (module, exports, __nested_webpack_require_183917__) {
      var Parser = __nested_webpack_require_183917__(21);

      var Handler = __nested_webpack_require_183917__(22);
    ...
    /***/
    function (module, exports, __nested_webpack_require_213165__) {
      /*
          ## RegExp Handler
       ...
       */
      var Util = __nested_webpack_require_213165__(3);

      var Random = __nested_webpack_require_213165__(5);
      /*
      ...
      Handler.extend({
        ...
        */
        quantified: function quantified(node, result, cache) {
          ...
          var count = this.quantifier(node.quantifier); // node.body {}
        ...
        */
        charset: function charset(node, result, cache) {
          // node.invert
          if (node.invert) return this['invert-charset'](node, result, cache); // node.body []
    ...
    /***/
    function (module, exports, __nested_webpack_require_225949__) {
      module.exports = __nested_webpack_require_225949__(24);
      /***/
    },
    /* 24 */

    /***/
    function (module, exports, __nested_webpack_require_226094__) {
      /*
          ## toJSONSchema
      	    把 Mock.js 风格的数据模板转换成 JSON Schema。
      	    > [JSON Schema](http://json-schema.org/)
       */
      var Constant = __nested_webpack_require_226094__(2);

      var Util = __nested_webpack_require_226094__(3);

      var Parser = __nested_webpack_require_226094__(4);
    ...
    /***/
    function (module, exports, __nested_webpack_require_227563__) {
      module.exports = __nested_webpack_require_227563__(26);
      /***/
    },
    /* 26 */

    /***/
    function (module, exports, __nested_webpack_require_227708__) {
      /*
          ## valid(template, data)
      ...
      */
      var Constant = __nested_webpack_require_227708__(2);

      var Util = __nested_webpack_require_227708__(3);

      var toJSONSchema = __nested_webpack_require_227708__(23);

      function valid(template, data) {
        var schema = toJSONSchema(template);
        var result = Diff.diff(schema, data);

        for (var i = 0; i < result.length; i++) {// console.log(template, data)
      ...
      */
      ...
      var Diff = {
        ...
        value: function value(schema, data, name, result) {
          ...
          if (templateType === 'object' || templateType === 'array' || templateType === 'function') return true; // 无生成规则
        ...
        properties: function properties(schema, data, name, result) {
          ...
          if (!schema.properties) return; // 无生成规则
    ...
    /***/
    function (module, exports, __nested_webpack_require_243704__) {
      module.exports = __nested_webpack_require_243704__(28);
      /***/
    },
    /* 28 */

    /***/
    function (module, exports, __nested_webpack_require_243849__) {
       ...
       */
      var Util = __nested_webpack_require_243849__(3); // 备份原生 XMLHttpRequest
      ...
      */
      ...
      Util.extend(MockXMLHttpRequest.prototype, XHR_STATES); // 标记当前对象为 MockXMLHttpRequest

      MockXMLHttpRequest.prototype.mock = true; // 是否拦截 Ajax 请求

      MockXMLHttpRequest.prototype.match = false; // 初始化 Request 相关的属性和方法
      ...
      Util.extend(MockXMLHttpRequest.prototype, {
        ...
        open: function open(method, url, async, username, password) {
          ...
          if (!item) {
            ...
            if (username) xhr.open(method, url, async, username, password);else xhr.open(method, url, async); // 同步属性 MockXMLHttpRequest => NativeXMLHttpRequest
